  ...
  return (
    <div className="min-h-full p-4 md:p-8">
      ...
      <div className="space-y-4">
        {sections.map((s) => (
          <div key={s.title} className="flex items-start gap-4 rounded-2xl border border-zinc-200/60 bg-white p-5 shadow-sm transition-colors hover:bg-zinc-50">
            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-zinc-100">
              <s.icon size={18} className="text-zinc-600" />
            </div>
            <div>
