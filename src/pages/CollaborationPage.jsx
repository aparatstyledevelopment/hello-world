    ...
    <div className="h-1.5 w-full rounded-full bg-gray-100">
      <div
        className={cn(
          ...
          pct >= 80 ? "bg-red-500" : pct >= 50 ? "bg-gray-400" : "bg-black"
        )}
        style={{ width: `${pct}%` }}
      />
    </div>
...
export function CollaborationPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-black">Team Collaboration</h1>
      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          <h2 className="text-base font-bold text-black">Team Workload Overview</h2>
          ...
          {teamData.map((member) => (
            ...
            >
              <div className="flex items-start gap-4">
                {/* Avatar */}
                <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-gray-200 text-sm font-bold text-gray-700 flex-shrink-0">
                  {member.initials}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="inline-flex items-center rounded-full bg-gray-100 text-gray-800 border border-gray-200 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.05em]">
                      {member.role}
                    </span>
                  </div>

                  <p className="text-xs text-gray-500 mb-3">{member.focus}</p>
            ...
            <tbody className="divide-y divide-gray-100">
              {coverageMap.map((row) => (
                <tr key={row.id} className={cn(
                  ...
                  <td className="px-4 py-2.5">
                    <span className="inline-flex items-center rounded-full bg-gray-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.05em] text-gray-600">
                      {row.type}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-2.5">
                    {row.openItems > 0 ? (
                      <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-gray-100 px-1.5 font-mono text-xs font-semibold text-gray-700">
                        {row.openItems}
                      </span>
                    ) : (
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-bold text-black">Log & Actions</h2>
          <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-black px-1.5 font-mono text-[10px] font-bold text-white">
            {handoffNotes.length}
          </span>
        </div>
          ...
          {handoffNotes.map((note) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gray-200 text-[10px] font-bold text-gray-700">
                  {note.fromInitials}
                </div>
